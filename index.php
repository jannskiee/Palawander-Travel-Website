...
<div class="container-fluid px-0 position-relative" id="tour">
    ...
    <div class="tour-carousel-wrapper position-relative">
        ...
        <div class="tours-scroll-container" id="tourContainer">
            ...
            <div class="tour-card-fixed">
                <div class="card h-100 rounded-4 card-price card-tour">
                    <img src="assets/images/tour-card-img1.jpg" class="card-img-top rounded-4 img-price" alt="...">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Paddle through a world-famous underground cave system filled with stunning
                            rock formations.</p>
                        <div class="price-container">
                            <p class="price-text">STARTS AT</p>
                            <p class="price-tag currency-target" data-base-price="2000">₱2,000</p>
                        </div>
                    </div>
                    <a type="button" href="tours/puerto-princesa-tour.php"
            ...
            <div class="tour-card-fixed">
                <div class="card h-100 rounded-4 card-price card-tour">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Explore lagoons, beaches, and limestone cliffs — including the iconic Big
                            Lagoon.</p>
                        <div class="price-container">
                            <p class="price-text">STARTS AT</p>
                            <p class="price-tag currency-target" data-base-price="1500">₱1,500</p>
                        </div>
                    </div>
                    <a type="button" href="tours/el-nido-tour.php" class="btn btn-outline-dark rounded-circle card-btn">
                        <i class="bi bi-arrow-right fs-4"></i>
                    </a>
                </div>
            </div>
            ...
            <div class="tour-card-fixed">
                <div class="card h-100 rounded-4 card-price card-tour">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Swim in crystal-clear lakes, snorkel WWII shipwrecks, and relax on
                            white-sand beaches.</p>
                        <div class="price-container">
                            <p class="price-text">STARTS AT</p>
                            <p class="price-tag currency-target" data-base-price="1800">₱1,800</p>
                        </div>
                    </div>
                    <a type="button" href="tours/coron-tour.php" class="btn btn-outline-dark rounded-circle card-btn">
                        <i class="bi bi-arrow-right fs-4"></i>
                    </a>
                </div>
            </div>
            ...
            <div class="tour-card-fixed">
                <div class="card h-100 rounded-4 card-price card-tour">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Visit remote islands, vibrant coral reefs, and turtle sanctuaries around
                            peaceful Port Barton.</p>
                        <div class="price-container">
                            <p class="price-text">STARTS AT</p>
                            <p class="price-tag currency-target" data-base-price="1200">₱1,200</p>
                        </div>
                    </div>
                    <a type="button" href="tours/san-vicente-tour.php"
                       class="btn btn-outline-dark rounded-circle card-btn">
                        <i class="bi bi-arrow-right fs-4"></i>
                    </a>
                </div>
            ...
            <div class="tour-card-fixed">
                <div class="card h-100 rounded-4 card-price card-tour">
                    ...
                    <div class="card-body">
                        ...
                        <div class="price-container">
                            <p class="price-text">STARTS AT</p>
                            <p class="price-tag currency-target" data-base-price="2500">₱2,500</p>
                        </div>
                    </div>
                    <a type="button" href="tours/balabac-tour.php" class="btn btn-outline-dark rounded-circle card-btn">
                        <i class="bi bi-arrow-right fs-4"></i>
                    </a>
                </div>
            </div>
            ...
            <div class="tour-card-fixed">
                <div class="card h-100 rounded-4 card-price card-tour">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Discover Taytay’s 17th-century Spanish fort, then sail to nearby
                            islands.</p>
                        <div class="price-container">
                            <p class="price-text">STARTS AT</p>
                            <p class="price-tag currency-target" data-base-price="1500">₱1,500</p>
                    ...
                    <a type="button" href="tours/taytay-tour.php" class="btn btn-outline-dark rounded-circle card-btn">
                        <i class="bi bi-arrow-right fs-4"></i>
                    </a>
                </div>
            </div>
        ...
        <button class="scroll-arrow scroll-right d-none d-sm-flex" id="scrollRightBtn">
...
<div class="container-fluid py-5 px-5" id="blogs">
    <div class="row">
        ...
        <div class="col-12 col-md-6 mb-4">
            ...
            <a
                    class="btn btn-outline-dark rounded-pill rd-al-artcls my-4"
                    href="#cards-blogs"
            >
                Read all articles
            </a>
    ...
    <div class="row row-cols-1 row-cols-md-2 g-4" id="cards-blogs">
        <div class="col">
            <div class="card h-100 rounded-4 card-price card-blog">
                ...
                <a
                        class="btn btn-outline-dark rounded-pill rd-al-artcls blog-btn my-4"
                        type="button"
                        href="blogs/el-nido-blog.php"
                        target="_blank"
                >
        ...
        <div class="col">
            <div class="card h-100 rounded-4 card-price card-blog">
                ...
                <a
                        class="btn btn-outline-dark rounded-pill rd-al-artcls blog-btn my-4"
                        type="button"
                        href="blogs/puerto-princesa-blog.php"
                        target="_blank"
                >
                    Read more <i class="bi bi-arrow-right fs-4"></i>
                </a>
...
<div class="container-fluid px-5 pt-3 pb-5">
    <div class="row text-center pb-3z">
        <div class="col-12 mb-4 text-center">
            ...
            <p class="testimonial-p">Hear from our travelers who experienced the beauty and adventure of Palawan. Their
                stories and feedback show what makes this paradise truly unforgettable.</p>
                    ...
                    <div class="card testimonial-card position-relative">
                        <div class="card-body marquee-first">
                            ...
                            <p class="card-text mt-2">
                                “I had an amazing time exploring Palawan. Everything felt calm and refreshing. I would
                                definitely come back again.”
                            </p>

                            <div class="profile-section d-flex align-items-center">
                                <img src="assets/images/profile_img/profile-pic-sam.jpg" class="profile-img"
                                     alt="Profile"/>
                ...
                <div class="card-item">
                    <div class="card testimonial-card position-relative">
                        <div class="card-body marquee-first">
                            ...
                            <p class="card-text mt-2">
                                “The trip was very organized from start to finish. The guides were friendly and very
                                helpful. I loved every moment.”
                            </p>

                            <div class="profile-section d-flex align-items-center">
                                <img src="assets/images/profile_img/profile-pic-guy1.jpg" class="profile-img"
                                     alt="Profile"/>
                                <div class="ms-2 profile-text">
                ...
                <div class="card-item">
                    <div class="card testimonial-card position-relative">
                        <div class="card-body marquee-first">
                            ...
                            <p class="card-text mt-2">
                                “Such a beautiful experience. The beaches were stunning and peaceful. Truly worth the
                                visit.”
                            </p>

                            <div class="profile-section d-flex align-items-center">
                                <img src="assets/images/profile_img/profile-pic-girl1.jpg" class="profile-img"
                                     alt="Profile"/>
                                <div class="ms-2 profile-text">
                ...
                <div class="card-item">
                    <div class="card testimonial-card position-relative">
                        <div class="card-body marquee-first">
                            ...
                            <p class="card-text mt-2">
                                “I enjoyed every part of the island tour. The staff were kind and professional. Highly
                                recommended.”
                            </p>

                            <div class="profile-section d-flex align-items-center">
                                <img src="assets/images/profile_img/profile-pic-guy2.jpg" class="profile-img"
                                     alt="Profile"/>
                                <div class="ms-2 profile-text">
                ...
                <div class="card-item">
                    <div class="card testimonial-card position-relative">
                        <div class="card-body marquee-first">
                            ...
                            <p class="card-text mt-2">
                                “Great value for the experience. Everything was well-planned and smooth. I’ll be
                                recommending this to my friends.”
                            </p>

                            <div class="profile-section d-flex align-items-center">
                                <img src="assets/images/profile_img/profile-pic-guy3.jpg" class="profile-img"
                                     alt="Profile"/>
                                <div class="ms-2 profile-text">
                ...
                <div class="card-item">
                    <div class="card testimonial-card position-relative">
                        <div class="card-body marquee-first">
                            ...
                            <p class="card-text mt-2">
                                “The entire trip felt magical. The views were breathtaking, and the service was
                                excellent. I couldn’t ask for more.”
                            </p>

                            <div class="profile-section d-flex align-items-center">
                                <img src="assets/images/profile_img/profile-pic-girl2.jpg" class="profile-img"
                                     alt="Profile"/>
                                <div class="ms-2 profile-text">
                ...
                <div class="card-item">
                    <div class="card testimonial-card position-relative">
                        <div class="card-body marquee-first">
                            ...
                            <div class="profile-section d-flex align-items-center">
                                <img src="assets/images/profile_img/profile-pic-girl3.jpg" class="profile-img"
                                     alt="Profile"/>
                                <div class="ms-2 profile-text">
                ...
                <div class="card-item">
                    <div class="card testimonial-card position-relative">
                        <div class="card-body marquee-first">
                            ...
                            <p class="card-text mt-2">
                                “I loved the peaceful atmosphere. Every spot we visited felt like a postcard. Truly
                                unforgettable.”
                            </p>

                            <div class="profile-section d-flex align-items-center">
                                <img src="assets/images/profile_img/profile-pic-guy4.jpg" class="profile-img"
                                     alt="Profile"/>
                                <div class="ms-2 profile-text">
                ...
                <div class="card-item">
                    <div class="card testimonial-card position-relative">
                        <div class="card-body marquee-first">
                            ...
                            <p class="card-text mt-2">
                                “Everything exceeded my expectations. The guides were very knowledgeable. I felt safe
                                the whole time.”
                            </p>

                            <div class="profile-section d-flex align-items-center">
                                <img src="assets/images/profile_img/profile-pic-girl4.jpg" class="profile-img"
                                     alt="Profile"/>
                                <div class="ms-2 profile-text">
                ...
                <div class="card-item">
                    <div class="card testimonial-card position-relative">
                        <div class="card-body marquee-first">
                            ...
                            <p class="card-text mt-2">
                                “Such an awesome trip. The scenery was unreal, and the water was crystal clear. Perfect
                                for nature lovers.”
                            </p>

                            <div class="profile-section d-flex align-items-center">
                                <img src="assets/images/profile_img/profile-pic-guy5.jpg" class="profile-img"
                                     alt="Profile"/>
                                <div class="ms-2 profile-text">
                ...
                <div class="card-item">
                    <div class="card testimonial-card position-relative">
                        <div class="card-body marquee-first">
                            ...
                            <p class="card-text mt-2">
                                “It was one of the best vacations I’ve ever had. The food, the views, the
                                people—perfect. I will definitely recommend this.”
                            </p>

                            <div class="profile-section d-flex align-items-center">
                                <img src="assets/images/profile_img/profile-pic-girl5.jpg" class="profile-img"
                                     alt="Profile"/>
                                <div class="ms-2 profile-text">
                ...
                <div class="card-item">
                    <div class="card testimonial-card position-relative">
                        <div class="card-body marquee-first">
                            ...
                            <p class="card-text mt-2">
                                “The experience was smooth and stress-free. The staff made sure everything was
                                comfortable. I really enjoyed the tour.”
                            </p>

                            <div class="profile-section d-flex align-items-center">
                                <img src="assets/images/profile_img/profile-pic-guy6.jpg" class="profile-img"
                                     alt="Profile"/>
                                <div class="ms-2 profile-text">
